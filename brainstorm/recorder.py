...
from brainstorm.application import Application
from brainstorm.utils import Factory
...
#TODO : exporter les object detector dans une nouvelle classe detector, ne garder que le recording ici
